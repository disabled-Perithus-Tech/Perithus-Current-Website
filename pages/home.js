...
export const Home = () => {
  ...
  return(
    ...
    <div className='parceiros'>
        ...
        <a className='imgParc1'><img  src='./../parc1.png' ></img></a>        
        <a className='imgParc2'><img  src='./../parc2.png'></img></a>
        <a className='imgParc3'><img  src='./../parc3.jpg'></img></a>
        <a className='imgParc4'><img  src='./../parc4.png'></img></a>
        </div>
